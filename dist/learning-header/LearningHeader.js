...
var LearningHeader = function LearningHeader(_ref) {
  ...
  }, intl.formatMessage(messages.about)), /*#__PURE__*/React.createElement("a", {
    className: "nav-link",
    href: "".concat(config.LMS_BASE_URL, "/courses")
  }, intl.formatMessage(messages.courses)), /*#__PURE__*/React.createElement("a", {
    className: "nav-link",
    href: "".concat(config.LMS_BASE_URL, "/#programs")
  }, intl.formatMessage(messages.programs))), /*#__PURE__*/React.createElement("div", {
